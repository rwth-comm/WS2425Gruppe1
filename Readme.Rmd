...
ggplot(df) +
  ...
  labs(
    ...
    title = paste0("Zusammenhangs zwischen der Neigung, in Technik zu vertrauen und der Einstellung von Bürger*innen gegenüber einem Chatbot n = (", nrow(df), ")"),
